...
void funcionalidades(int, int); // precisa criar ela aqui em cima tbm para nao dar erro no escopo, mais necessariamente essa mensagem -> was not declared in this scope
...
void funcionalidades (int sock, int modoExib) // So chega nessa parte se um cliente conseguir conectar-se com êxito ao servidor
{   
    char buffer[1024];
